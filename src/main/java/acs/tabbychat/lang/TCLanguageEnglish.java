...
public class TCLanguageEnglish extends TCLanguage {
	...
	static {
		...
		defaults.setProperty("settings.general.updatecheckenable", "Check for Updates");
		...
		defaults.setProperty("settings.advanced.convertunicodetext", "Convert unicode syntax");
