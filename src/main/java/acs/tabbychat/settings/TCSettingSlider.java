...
public class TCSettingSlider extends TCSetting implements ITCSetting {
	...
	public void drawButton(Minecraft par1, int cursorX, int cursorY) {
		...
		this.drawRect(this.x(), this.y()+1, this.x()+1, this.y() + this.height()-1, fgcolor);
		this.drawRect(this.x()+1, this.y(), this.x()+this.width()-1, this.y()+1, fgcolor);
		this.drawRect(this.x()+1, this.y()+this.height()-1, this.x()+this.width()-1, this.y()+this.height(), fgcolor);
		this.drawRect(this.x()+this.width()-1, this.y()+1, this.x()+this.width(), this.y()+this.height()-1, fgcolor);
		this.drawRect(this.x()+1, this.y()+1, this.x()+this.width()-1, this.y()+this.height()-1, 0xff000000);

		this.sliderX = Math.round(this.sliderValue * (this.width() - 5)) + this.x() + 1;
		this.drawRect(this.sliderX, this.y()+1, this.sliderX+1, this.y()+2, buttonColor & 0x88ffffff);
		this.drawRect(this.sliderX+1, this.y()+1, this.sliderX+2, this.y()+2, buttonColor);
		this.drawRect(this.sliderX+2, this.y()+1, this.sliderX+3, this.y()+2, buttonColor & 0x88ffffff);
		this.drawRect(this.sliderX, this.y()+2, this.sliderX+1, this.y()+this.height()-2, buttonColor);
		this.drawRect(this.sliderX+1, this.y()+2, this.sliderX+2, this.y()+this.height()-2, buttonColor & 0x88ffffff);
		this.drawRect(this.sliderX+2, this.y()+2, this.sliderX+3, this.y()+this.height()-2, buttonColor);
		this.drawRect(this.sliderX, this.y()+this.height()-2, this.sliderX+1, this.y()+this.height()-1, buttonColor & 0x88ffffff);
		this.drawRect(this.sliderX+1, this.y()+this.height()-2, this.sliderX+2, this.y()+this.height()-1, buttonColor);
		this.drawRect(this.sliderX+2, this.y()+this.height()-2, this.sliderX+3, this.y()+this.height()-1, buttonColor & 0x88ffffff);
		...
		this.drawCenteredString(mc.fontRenderer, valLabel, valCenter+this.x(), this.y()+2, buttonColor);
